...
Joint environment mapping using UAV and UGV, with synchronized scene, point cloud, and trajectory visualization.
...
Air-ground tracking: UAV for global aerial view, UGV for local ground tracking.
