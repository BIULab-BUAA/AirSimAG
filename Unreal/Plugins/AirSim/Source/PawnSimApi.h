...
protected: //additional interface for derived class
    ...
    // Height offset (in Unreal units, 1 unit = 1 cm) added to trace line for visibility. Override in CarPawnSimApi.
    virtual float getTraceHeightOffset() const { return 0.0f; }
